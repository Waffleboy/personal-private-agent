...
| :---: | :---: |
| Auto categorizes text | Handles voice notes via Gemini API (other models require more plumbing yet to be built) |
...
# edit: telegram_bot_token, gemini_api_key, allowed_users
cd infra && terraform init && terraform apply
```

If you use gemini, voice notes are supported out of the box. Not so for the other models as of now.
